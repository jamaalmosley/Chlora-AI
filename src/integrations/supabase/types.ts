  ...
  public: {
    Tables: {
      ...
      checklist_item_completions: {
        ...
        Relationships: [
          {
            foreignKeyName: "checklist_item_completions_checklist_id_fkey"
            columns: ["checklist_id"]
            isOneToOne: false
            referencedRelation: "surgery_checklists"
            referencedColumns: ["id"]
          },
        ]
      }
      checklist_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "checklist_templates_practice_id_fkey"
            columns: ["practice_id"]
            isOneToOne: false
      ...
      patient_invitations: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_invitations_practice_id_fkey"
            columns: ["practice_id"]
            isOneToOne: false
            referencedRelation: "practices"
            referencedColumns: ["id"]
      ...
      physician_patient_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "physician_patient_requests_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "patients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "physician_patient_requests_practice_id_fkey"
            columns: ["practice_id"]
            isOneToOne: false
            referencedRelation: "practices"
            referencedColumns: ["id"]
      ...
      preop_images: {
        ...
        Relationships: [
          {
            foreignKeyName: "preop_images_surgery_id_fkey"
            columns: ["surgery_id"]
            isOneToOne: false
      ...
      surgery_checklists: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "surgery_checklists_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
